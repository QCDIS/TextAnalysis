...
class XPLORE:
    ...
    def __init__(self, api_key):
        ...
        self.allowedSearchFields = ['abstract', 'affiliation', 'article_number', 'article_title', 'author',
                                    'boolean_text', 'content_type', 'd-au', 'd-pubtype', 'd-publisher', 'd-year',
                                    'doi', 'end_year', 'facet', 'index_terms', 'isbn', 'issn', 'is_number',
                                    'meta_data', 'open_access', 'publication_number', 'publication_title',
                                    'publication_year', 'publisher', 'querytext', 'start_year', 'thesaurus_terms']
    ...
    def formatData(self, data):
        ...
        if self.outputDataFormat == 'raw':
            ...
            if self.outputType == 'xml':
                obj = ElementTree(fromstring(data))
                return obj
